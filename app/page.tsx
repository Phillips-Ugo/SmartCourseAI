...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-primary via-background-secondary to-background-primary overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-accent/5 to-purple-500/5 rounded-full blur-3xl animate-pulse"></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-accent/20 to-purple-500/20 backdrop-blur-sm border border-border/10 rounded-full px-6 py-3 mb-8"
            >
              <Sparkles className="w-5 h-5 text-accent" />
              <span className="text-accent font-medium">AI-Powered Course Recommendations</span>
            </motion.div>
            ...
            >
              Welcome to{' '}
              <span className="text-gradient bg-gradient-to-r from-accent via-purple-400 to-pink-400">
                SmartCourseAI
              </span>
            </motion.h1>
          ...
          >
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-r from-accent to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <Brain className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold mb-4 text-foreground-primary">AI-Powered Recommendations</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 text-foreground-primary">AI Chatbot Assistant</h3>
              <p className="text-foreground-secondary leading-relaxed">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 text-foreground-primary">Smart Planning</h3>
              <p className="text-foreground-secondary leading-relaxed">
          ...
          >
            <div className="glass-card p-6 text-center">
              ...
              <div className="text-foreground-secondary">Courses Available</div>
            </div>
            <div className="glass-card p-6 text-center">
            ...
            <div className="glass-card p-6 text-center">
              ...
              <div className="text-foreground-secondary">Students Helped</div>
            </div>
            <div className="glass-card p-6 text-center">
              <div className="text-3xl font-bold text-gradient mb-2">24/7</div>
              <div className="text-foreground-secondary">AI Support</div>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-card p-8">
              <div className="flex mb-8 bg-background-secondary/50 rounded-xl p-1">
                <button
                  onClick={() => setShowLogin(true)}
